...
namespace MSTranslationSample
{
    class Program
    {
        ...
        private static void DetectMethod(string authToken)
        {
            ...
            {
                englishText = reader.ReadToEnd();
            }
            Console.WriteLine("English");
            Console.WriteLine(englishText);
            Console.WriteLine("-----------");

            string uri = string.Concat("http://api.microsofttranslator.com/v2/Http.svc/Translate?text=", HttpUtility.UrlEncode(englishText),
                "&from=", from, "&to=", to);
            ...
            try
            {
                ...
                using (Stream stream = response.GetResponseStream())
                {
                    ...
                    Console.WriteLine(string.Format("Translation:{0}", translatedText));
                    Console.WriteLine("Press any key to continue...");
                    Console.ReadKey(true);
                }
            }
